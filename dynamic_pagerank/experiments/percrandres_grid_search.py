...
if is_jupyter_env():
    ...
    import sys; sys.argv=['', 'data/datasets/transformedts_6.csv', '10', '100', '', ''];
...
random_resample = build_resample_regression_dataset_func(ros, stepsize=args.stepsize, jitter=True)
